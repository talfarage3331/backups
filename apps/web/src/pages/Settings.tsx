    ...
    <div className="main-content animate-fade-in">
      ...
      {deleteModal && (
        <ConfirmModal
          ...
          body="Are you sure you want to delete your account? This will permanently delete your EnvShield account, all configuration settings, and pipeline run logs. This action cannot be undone."
          ...
          <div className="danger-actions">
            <div className="danger-action-row">
              <div>
                ...
                <div className="danger-action-desc">Permanently deletes your EnvShield account, settings profiles, and database documents. Irreversible.</div>
              </div>
